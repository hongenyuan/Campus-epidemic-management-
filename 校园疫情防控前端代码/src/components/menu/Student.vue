                        ...
                        <el-col :span="12">
                            <el-menu default-active="2" class="el-menu-vertical-demo" @open="handleOpen"
                                ...
                                <el-submenu index="1">
                                    ...
                                    <el-menu-item-group>
                                        <el-menu-item index="/student/showUser">个人信息</el-menu-item>
                                        <el-menu-item index="/student/updateUser">信息修改</el-menu-item>
                                        <el-menu-item index="/student/updatePwd">密码重设</el-menu-item>
                                        <el-menu-item index="/student/updateHead">头像设置</el-menu-item>
                                    </el-menu-item-group>
                                </el-submenu>
                                ...
                                <el-menu-item index="/student/setLeave">
                                    <i class="el-icon-setting"></i>
                                    <span slot="title">假条申请</span>
                                </el-menu-item>
                                <el-submenu index="5">
                                    <template slot="title">
                                        <i class="el-icon-location"></i>
        ...
        computed: {
            ...
            setHealthurl() { //菜单栏的index不能跟函数要跟属性
                ...
                if (JSON.parse(localStorage.getItem('updateHealthtime')) === date.getDate()) {
                    return '/student/getNowdayHeal'
                } else {
                    return '/student/setHealth'
                }
            }
        },
        //用来渲染main模块的初始页面
